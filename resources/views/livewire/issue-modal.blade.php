<div>
    <x-tas-secondary-button wire:click.prevent="showModal" wire:loading.attr="disabled" class="m-1 rounded-full border border-purple-700 text-sm px-2 py-2 text-purple-700">
        Report an Issue with this Usecase
    </x-tas-secondary-button>

    <x-modal maxWidth="md" class="flex items-center" id="issueModal" wire:model="showingModal">
        <form wire:submit.prevent="send">
            @csrf
            <div class="px-6 py-4">
                <div class="text-lg font-medium text-gray-900">
                    Report an Issue about '{{$usecase_title}}'
                </div>
                <div class="mt-4 text-sm text-gray-600">
                    ...
                    @if(!$sent)
                        ...
                        <div class="mt-4">
                            <x-label for="message" value="Problem" />
