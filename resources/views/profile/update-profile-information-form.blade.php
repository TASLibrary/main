<div class="py-6">
    <form wire:submit.prevent="updateProfileInformation">
        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8 mt-4">
            ...
            <x-input id="affiliation" type="text" class="mt-1 block w-full" wire:model.defer="state.affiliation" required autocomplete="affiliation" />
        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8 text-right mt-4">
            ...
            <x-tas-button wire:loading.attr="disabled" wire:target="photo">
                Save
            </x-tas-button>
        </div>
    </form>
